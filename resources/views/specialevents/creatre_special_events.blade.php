...
<div id="create_special_event" class="modal">
    <div class="modal-dialog">
        <div class="modal-content model-style">
            <div class="modal-header">
                <h6>{{trans('specialevents.Create Special Events')}}</h6>
            ...
            <div class="modal-footer">
                <button id="create_s_event" class="btn btn-primary" type="button"
                        data-bs-dismiss="modal">{{trans('specialevents.Create')}}</button>
            </div>
        </div>
    </div>
</div>
