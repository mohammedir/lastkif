...
<div id="create_annual_report" class="modal">
    <div class="modal-dialog">
        <div class="modal-content model-style">
            <div class="modal-header">
                <h6>{{trans('annualreports.Create Annual Report')}}</h6>
            ...
            <div class="modal-footer">
                <button id="create_a_report" class="btn btn-primary" type="button"
                        data-bs-dismiss="modal">{{trans('annualreports.Create')}}</button>
            </div>
        </div>
    </div>
</div>
