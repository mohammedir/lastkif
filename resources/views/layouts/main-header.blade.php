...
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="text-left navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{ url('/dashboard') }}"><img
                    src="{{asset("images/kifLandsacpeLogo.png")}}" alt=""></a>
        ...
        {{--@if(config('app.locale') == "ar")
            ...
            <a class="navbar-brand brand-logo-mini" href="{{ url('/dashboard') }}"><img
                        src="{{ asset("images/kifLandsacpeLogo.png") }}" alt=""></a>
        @else
            <a class="navbar-brand brand-logo" href="{{ url('/dashboard') }}" style=" transform: scaleX(-1);"><img
                        src="{{asset("images/kifLandsacpeLogo.png")}}" alt=""></a>
            <a class="navbar-brand brand-logo-mini" href="{{ url('/dashboard') }}" style=" transform: scaleX(-1);"><img
                        src="{{ asset("images/kifLandsacpeLogo.png") }}" alt=""></a>
        @endif--}}
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="{{ route('logout') }}"
                   onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i
                            class="text-danger ti-unlock"></i>{{ __('main-sidebar-trans.logout') }}</a>
